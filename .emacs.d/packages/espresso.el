...
(defvar espresso-mode-map
  (let ((keymap (make-sparse-keymap)))
    ...
    (easy-menu-define nil keymap "Espresso Menu"
      '("Javascript"
        ["Select new Mozilla context鈥�" espresso-set-js-context
         (fboundp #'inferior-moz-process)]
        ["Evaluate expression in Mozilla context鈥�" espresso-js-eval
         (fboundp #'inferior-moz-process)]
        ["Send current function to Mozilla鈥�" espresso-eval-defun
         (fboundp #'inferior-moz-process)]
        )
      )
